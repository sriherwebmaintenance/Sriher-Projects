...
👉 [WooCommerce Order Status Notifications](https://plugins.miniorange.com/how-to-configure-woocommerece-sms-notification)
...
👉 [Custom SMS & Email Gateways](https://plugins.miniorange.com/supported-sms-email-gateways) and many more.

Check more about the miniOrange WordPress OTP Verification & SMS Notifications Plugin:

[https://www.youtube.com/watch?v=BcvzJV9OxQE]

= THIRD PARTY CUSTOM SMS GATEWAY FOR OTP Verification and SMS Notifications ( OTP Verification ) =
In OTP Verification Plugin you can use **your third party gateway** for sending the SMS/Email.
You can also use **miniOrange gateway** to perform OTP verification over Phone/SMS and Email or to send SMS notifications. We support OTP Verification worldwide.
...
Follow the link for detailed information on the free and premium addons supported in the OTP Verification plugin : [OTP Verification Addons Supported](https://plugins.miniorange.com/wordpress-otp-verification#addons-section)

= LOGIN WITH PHONE NUMBER =
Login with Phone add-on allows user to login in using phone number only. Login with Phone is the most feasible technique for loggin in. Contact us at **otpsupport@xecurify.com** to know more.
...
> + [Reales WP Theme Registration Form]
...
2. Once the OTP is entered, it is verified and the user gets registered/login.

= How is this plugin better than other plugins available? =
1. Verification of user's Email Address/Mobile Number during registration & Login is a must these days. But what if you do not have your own SMTP/SMS gateway? With our plugin it's not necessary to have your own SMTP/SMS gateway. You can use our gateways to send OTP over Email/SMS.
...
To get support for custom forms or a plugin designed form, please email us at **otpsupport@xecurify.com/info@xecurify.com** with a Form Name & Form Link. You can also submit your query from the plugin's settings page.
 ...
 * Added OTP over new WooCommerce Checkout Form

= 5.1.0 =
* miniOrange WordPress OTP Verification
 * Added redirection option after Login with OTP
 * Added options in Contact us for queries form
 * Added Whatsapp Notification Functionality test feature
 * Added option to reset OTP popup to default
 ...
 * Introduced Pop UP Template custom fields feature
 * Enhanced country code dropdown feature
 * Enhanced feature to update common messages in the plugin
 * Compatibility fixes in Memberpress checkout form and Memberpress Registration form
 * Added duplicate phone numbers check in Eduma Registration form
