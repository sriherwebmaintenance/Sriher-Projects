...
function ubermenu_delete_all_item_settings()
{
	...
	if (
		...
		if ($_GET['do'] == 'delete-item-settings') {
		...
		//IMPORT DATA PANEL (PASTE EXPORT DATA)
			...
			<form action="<?php echo admin_url('themes.php?page=ubermenu-settings&do=settings-import'); ?>" method="POST">
				...
				<input type="submit" class="button button-primary"
					value="<?php _e('Confirm and Import Settings Now', 'ubermenu'); ?>" />
			</form>
	...
	<div class="wrap ubermenu-wrap">
		...
		if (!$old_ops) {
			...
			<form action="<?php echo admin_url('themes.php'); ?>" method="GET">
				...
				<label><input type="checkbox" checked="checked" value="on" name="migrate_control_panel" /> Migrate Control
					Panel</label>

				<p>This will migrate the settings from the UberMenu Control Panel, including the Style Generator settings if you
					had your Style Application set to the Style Generator.</p>
				...
				foreach ($menus as $menu): ?>
					<label><input type="checkbox" checked="checked" name="migrate_menu_ids[]"
							value="<?php echo $menu->term_id; ?>" /> <?php echo $menu->name; ?></label><br />
				<?php endforeach; ?>

				<br />
				<input type="submit" class="button button-primary"
					value="<?php _e('Confirm &amp; Migrate Settings', 'ubermenu'); ?>" />
			</form>
...
function ubermenu_reset_styles_complete_panel()
{
	...
	<div class="wrap ubermenu-wrap">
		...
		<h2><strong>UberMenu</strong> Style Customization Settings Reset <span
				class="ubermenu-version">v<?php echo UBERMENU_VERSION; ?></span></h2>
...
function ubermenu_reset_styles_check_panel()
{
	...
	<div class="wrap ubermenu-wrap">
		...
		<form action="<?php echo admin_url('themes.php'); ?>" method="GET">
			...
			<br />
			<input type="submit" class="button button-primary"
				value="<?php _e('Confirm &amp; Reset Style Customizations', 'ubermenu'); ?>" />
		</form>
		<?php
...
function ubermenu_reset_all_complete_panel()
{
	...
	<div class="wrap ubermenu-wrap">
		...
		<h2><strong>UberMenu</strong> Settings Reset <span class="ubermenu-version">v<?php echo UBERMENU_VERSION; ?></span>
		</h2>
...
function ubermenu_reset_all_check_panel()
{
	...
	<div class="wrap ubermenu-wrap">
		...
		<form action="<?php echo admin_url('themes.php'); ?>" method="GET">
			...
			<br />
			<input type="submit" class="button button-primary"
				value="<?php _e('Confirm &amp; Reset Settings', 'ubermenu'); ?>" />
		</form>
		<?php
...
function ubermenu_delete_all_menu_item_settings_check_panel()
{
	...
	<div class="wrap ubermenu-wrap">
		...
		<h2><strong>UberMenu</strong> Menu Item Settings Reset <span
				class="ubermenu-version">v<?php echo UBERMENU_VERSION; ?></span></h2>
		...
		<?php else: ?>
			...
			<form action="<?php echo admin_url('themes.php'); ?>" method="GET">
				...
				<br />
				<input type="submit" class="button button-primary"
					value="<?php _e('Confirm &amp; Delete Menu Item Settings', 'ubermenu'); ?>" />
			</form>
			<?php
...
function ubermenu_delete_all_menu_item_settings_complete_panel()
{
	...
	<div class="wrap ubermenu-wrap">
		...
		<h2><strong>UberMenu</strong> Menu Item Settings Deleted <span
				class="ubermenu-version">v<?php echo UBERMENU_VERSION; ?></span></h2>
...
{
	if (ubermenu_is_pro())
		echo '<a class="button button-quickstart" href="#"><i class="fas fa-bolt"></i> ' . __('Quick Start', 'ubermenu') . '</a> ';
	...
	if (ubermenu_is_pro())
		echo '<a target="_blank" class="button button-secondary" href="' . UBERMENU_TROUBLESHOOTER_URL . '"><i class="fas fa-wrench"></i> ' . __('Troubleshooter', 'ubermenu') . '</a> ';
	if (
		ubermenu_is_pro() &&
...
function ubermenu_check_menu_assignment()
{
	...
	if ($display == 'on') {
		if (!has_nav_menu('ubermenu')) {
			?>
			<div class="update-nag"><strong>Important!</strong> There is no menu assigned to the <strong>UberMenu [Main]</strong>
...
function ubermenu_settings_panel_go_pro($sections = array())
{
	...
	if (!UBERMENU_UPGRADE || UBERMENU_PRO)
		return $sections;
